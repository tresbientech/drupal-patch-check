...
class PatchText
{
    ...
    /**
     * One answer from a host read as a JSON document, or why there is none.
     *
     * @return array<mixed>|string
     */
    public function askJson(string $url): array|string
    {
        $answer = $this->ask($url);
        if (\is_string($answer)) {
            return $answer;
        ...
        return \is_array($decoded) ? $decoded : 'the host answered with something that is not JSON';
    }
